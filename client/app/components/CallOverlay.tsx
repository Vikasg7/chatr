...
export function CallOverlay({ status, callerName, onAnswer, onReject, onCancel, onEnd, onToggleAudio }: CallOverlayProps) {
                    ...
                    <div className="flex items-center gap-4">
                        {status === 'ACTIVE' && onToggleAudio && (
                            <button
                                ...
                                className="w-14 h-14 rounded-full bg-slate-700 hover:bg-slate-600 flex items-center justify-center transition shadow-lg"
