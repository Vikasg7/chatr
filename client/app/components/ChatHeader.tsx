...
export function ChatHeader({
  ...
  return (
    <div className="flex items-center justify-between pl-4 pr-3 md:pl-8 md:pr-4 py-token-2 border-b border-[var(--border-subtle)] bg-[var(--color-elevated)] transition-colors relative">
